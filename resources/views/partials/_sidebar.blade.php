    ...
    <ul class="menu-inner py-1">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="{{ route('countries.create') }}" class="menu-link">
              <div data-i18n="Without navbar">Add Countries</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="layouts-container.html" class="menu-link">
              <div data-i18n="Container">All Cities</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="layouts-fluid.html" class="menu-link">
              <div data-i18n="Fluid">Add Cities</div>
            </a>
          </li>
        </ul>
      </li>
      <li class="menu-item">
        ...
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Layouts">Car Rent</div>
        </a>

        <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-landscape"></i>
          <div data-i18n="Layouts">Tours</div>
        </a>
